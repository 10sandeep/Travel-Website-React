...
import Img2 from "../../assets/places/dubai.jpg";
...
const BlogsComp = () => {
  return (
    <>
      <div className="bg-black dark:bg-gray-900 dark:text-white py-10">
        <section data-aos="fade-up" className="container ">
        <div data-aos="fade-up" data-aos-duration="300" className="text-center mb-20 max-w-[400px] mx-auto">
           
            <h1 className="text-4xl text-white font-bold">Our Latest articles about travel</h1>
